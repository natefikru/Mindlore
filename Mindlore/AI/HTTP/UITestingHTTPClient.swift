...
nonisolated struct UITestingHTTPClient: HTTPClient {
    ...
    func send(_ request: URLRequest, body: Data?) async throws -> HTTPResponse {
        ...
        if path.hasSuffix("/models") {
            ...
            let insights = #"{"summary":"A walk by the river with Sarah.","primaryMood":"calm","secondaryMoods":["grateful"],"lifeAreas":["friends"],"tags":["river"],"mentions":[{"name":"Sarah","kind":"person"},{"name":"Tom","kind":"person"}],"looseEnds":[{"text":"Call the landlord","about":[],"due":null,"sameAs":null}],"cleanedText":null,"writtenDate":null}"#
